...
Route::middleware('auth:sanctum', 'ability:' . TokenAbility::ACCESS_API()->key())->group(function () {
 ...
 Route::get('/v1/transaction/ShowCreateTransaction', [TransactionController::class, 'ShowCreateTransaction']);
 Route::post('/v1/transaction/CreateTransaction', [TransactionController::class, 'CreateTransaction']);
